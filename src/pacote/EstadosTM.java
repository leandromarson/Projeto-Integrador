...
public class EstadosTM extends AbstractTableModel{
    
    private List<Estados> linhas;
    private String[] colunas = new String[]{"Estado","Bioma","População","Num. Infectados","Num. Mortes"};
    
    public EstadosTM(){
        linhas = new ArrayList<Estados>();
    }
    
    public EstadosTM(List<Estados> lista) {
    ...
    public void addEstados(Estados e) {
        // Adiciona o registro.
        linhas.add(e);
